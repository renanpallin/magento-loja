...
class Data extends AbstractHelper
{
    ...
    {
        $rola = $this->scopeConfig->getValue(
            "carriers/imaginationmedia_correios/weight_type",
            $this->storeScope
        );
        $this->logMessage("porra do weight_type $rola");
        $result = $weight;
        if (((string)$rola === 'gr')) {
    ...
    {
        $package = $request->getPackageWeight();
        $weight = $this->fixWeight($package);
        $this->logMessage("poha do weight $weight");
        $this->logMessage("poha do package $package");
        ...
        $this->logMessage("poha do max $maxWeight");
